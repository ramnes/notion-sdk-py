...
This integration polls a Notion database every 5 seconds and tracks status changes. When a page's Status property changes, it sends an email via [SendGrid](https://sendgrid.com).
...
Sign up for a free account at [SendGrid](https://sendgrid.com) and create an API key.
